...
#  <ul>
#  <li><a href=[export_vars -base contact-edit {user_id}]>Edit contact information</a>
#  </ul>"
#  } else {
#      append whole_page "<h3>Contact Info</h3>\n\n$contact_info\n
#  <ul>
#  <li><a href=[export_vars -base contact-edit {user_id}]>Add contact information</a>
#  </ul>"
#  }
...
#      set intranet_admin_link "<li><a href=\"[im_url_stub]/employees/admin/[export_vars -base view {user_id}]\">Update this user's employee information</a><p>"
#  } else {
